...
public class ExpandableMenuOverlay extends ImageButton implements DialogInterface.OnKeyListener, View.OnClickListener {
    ...
    private static final float DEFAULT_DIM_AMOUNT = 0.85f;
    ...
    private ExpandableButtonMenu.MenuButton  menubutton;
    ...
    public void init(AttributeSet attrs) {
        ...
        mDialog.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface dialogInterface) {
                setVisibility(View.INVISIBLE);//显示
                mButtonMenu.toggle();//切换
            }
        });
