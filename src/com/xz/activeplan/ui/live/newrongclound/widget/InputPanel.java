package com.xz.activeplan.ui.live.newrongclound.widget;
...
//                emojiBtn.setSelected(emojiBoard.getVisibility() == VISIBLE);
                ...
                {
                    flag = true;
                    emojiBtn.setImageResource(R.drawable.inputview_icon_keyboard);
                    emojiBoard.setVisibility(VISIBLE);
                    InputMethodManager imm = (InputMethodManager)getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
                    boolean isOpen=imm.isActive();//isOpen若返回true，则表示输入法打开
                    if(isOpen==true)
                    {
                        Utiles.closeKeyBoard(getContext(),textEditor);
                    }
                }else
                {
                    flag =false;
                    emojiBtn.setImageResource(R.drawable.inputview_icon_emoji);
                    emojiBoard.setVisibility(View.GONE);
                    Utiles.getKeyBoard(textEditor);
                }
            }
        });
