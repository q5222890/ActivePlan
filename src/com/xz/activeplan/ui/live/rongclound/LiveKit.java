package com.xz.activeplan.ui.live.rongclound;

import android.content.Context;
import android.os.Handler;

import com.xz.activeplan.ui.live.rongclound.message.BaseMsgView;
import com.xz.activeplan.ui.live.rongclound.message.GiftMessage;
import com.xz.activeplan.ui.live.rongclound.message.GiftMsgView;
import com.xz.activeplan.ui.live.rongclound.message.InfoMsgView;
import com.xz.activeplan.ui.live.rongclound.message.TextMsgView;
...
public class LiveKit {
     ...
     * 事件代码
     */
    public static final int MESSAGE_ARRIVED = 0;//接收
    public static final int MESSAGE_SENT = 1;  //发送
    ...
    public static void sendMessage(final MessageContent msgContent) {
        try {
            if (currentUser == null) {
                Utiles.log("currentUser should not be null.");
            }
        } catch (Exception e)
        {
        ...
        RongIMClient.getInstance().sendMessage(msg, null, null, new RongIMClient.SendMessageCallback() {
            ...
            public void onSuccess(Integer integer) {
                Utiles.log("消息对象"+msgContent.getUserInfo().getName());
