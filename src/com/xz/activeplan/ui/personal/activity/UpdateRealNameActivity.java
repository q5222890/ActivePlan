 ...
 * 
 */
public class UpdateRealNameActivity extends BaseFragmentActivity implements
		OnClickListener {
	...
	private void initViews() {
		...
		tvHeadTitle.setText("更改姓名");
		tvPrompts.setText("请务必填写真实姓名，以便接收票务信息");
		edUpdateContent.setHint("请输入真实姓名");
...
//			Toast.makeText(this, "网络无连接，请检查网络", Toast.LENGTH_LONG).show() ;
		...
		UserInfoServiceImpl.getInstance().saveUserInfo(
				...
				content, mUserInfoBean.getSignature(),
				...
				new StringCallback() {
					...
					public void onResponse(String response) {
						...
						if (obj != null) {
							...
							if (statusBean.getCode() == 0) {
								...
								mUserInfoBean.setRealname(content);
								SharedUtil.saveUserInfo(UpdateRealNameActivity.this, mUserInfoBean);
					...
					public void onFailure(Request request, IOException e) {
						mProgressDialog.dismiss();
//						Toast.makeText(UpdateRealNameActivity.this,
