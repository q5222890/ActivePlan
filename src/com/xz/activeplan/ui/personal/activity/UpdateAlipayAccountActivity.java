 ...
 * 
 */
public class UpdateAlipayAccountActivity extends BaseFragmentActivity implements
		OnClickListener {
	...
	private void initViews() {
		...
		tvHeadTitle.setText("更改支付宝账号");
		tvPrompts.setText("请准确填写支付宝账号");
		edUpdateContent.setHint("请输入支付宝账号");
...
//			Toast.makeText(this, "请输入支付宝账号", Toast.LENGTH_LONG).show();
		...
		UserInfoServiceImpl.getInstance().saveUserInfo(
				...
				mUserInfoBean.getPhonenum(), mUserInfoBean.getSex()+"", "",content,mUserInfoBean.getAlipayusername(),
				new StringCallback() {
					...
					public void onResponse(String response) {
						...
						if (obj != null) {
							...
							if (statusBean.getCode() == 0) {
								...
								mUserInfoBean.setAlipayaccount(content);
								SharedUtil.saveUserInfo(UpdateAlipayAccountActivity.this, mUserInfoBean);
								ClassConcrete.getInstance().postDataUpdate(new EventBean(EventType.ACCOUNT_CHANGE_TYPE)) ;
							}
						}
					}
					...
					public void onFailure(Request request, IOException e) {
						mProgressDialog.dismiss();
//						Toast.makeText(UpdateAlipayAccountActivity.this,
