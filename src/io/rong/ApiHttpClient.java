...
public class ApiHttpClient {
	...
	public static SdkHttpResult joinGroup(String appKey, String appSecret,String userId, String groupId, String groupName, FormatType format)
		...
		StringBuilder sb = new StringBuilder();
		sb.append("userId=").append(URLEncoder.encode(userId, UTF8));
		Utiles.log(" groupId:"+groupId+" groupName:"+groupName);
		sb.append("&groupId=").append(URLEncoder.encode(groupId, UTF8));
		sb.append("&groupName=").append(URLEncoder.encode(groupName==null?"":groupName, UTF8));
		sb.append("&categoryId=").append(URLEncoder.encode(100+"", UTF8));
		HttpUtil.setBodyParameter(sb,conn);
		return HttpUtil.returnResult(conn);
	}
	
	// 查询群成员
		public static SdkHttpResult queryGroup(String appKey, String appSecret,
				String groupId, FormatType format)
				throws Exception {

			HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(appKey,
					appSecret, RONGCLOUDURI + "/group/user/query." + format.toString());
